...
for (package in c('caret','readr','ggplot2','magrittr','ggthemes','dplyr','corrplot','caTools','RWeka')) {
...
p <- h2o.table(mushrooms.hex$class)
h2o.plot(p)
...
mushrooms.hex1 <- mushrooms.hex[1:100, c(1,6,9,10,12,13,20,21,22,23)]
mushrooms.hex1
